...
async def start(message: types.Message):
    await message.answer("дата: {} \n""число: {} \n""место: {} \n".format(tournament_date.strftime("%d.%m.%Y"), tournament_date.strftime("%d"),"Школа 160 в спортивном зале\n"
                                             "*********************************************\n"
...
async def start(message: types.Message):
    await message.answer("Это самый большой турнир в Школе 160\n"
                         "Он будет проведен в одном из классов школы\n"
                         "**************************\n"
                         "Мы приглашаем тебя на бесплатный турнир!\n"
                         "Все турниры, кроме финального, будут проведены в приложении по шахматам для смартфонов\n"
                         "**************************\n"
                         "Призовой фонд \n"
